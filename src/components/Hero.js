  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        <div
          className="absolute flex flex-col py-8 md:min-w-[760px] bottom-[-5%] mx-1 md:left-1/2 transform md:-translate-x-1/2 
        ...
        >
          ...
          <div className="flex justify-between flex-wrap px-4">
            ...
            <p className="flex px-4 py-2 text-slate-500">
              <DatabaseIcon className="h-6 text-indigo-500" />. Dashboard Design
            </p>
            <p className="flex px-4 py-2 text-slate-500">
